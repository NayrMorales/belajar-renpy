...
define config.name = _("Let Me Sleep")
...
define config.main_menu_music = "musics/menu/bensound-creativeminds.mp3"
...
define config.save_directory = "LetMeSleep-1555325660"
